YUI.add("moodle-block_webgd-navigation", function(e, t) {
    ...
    u.prototype = {
            ...
            if (!e.target.test("a") || e.keyCode !== 0 && e.keyCode !== 13) {
                ...
                if (!t.hasClass("depth_1"))
                    if (e.type === "actionkey") {
                        ...
                        e.halt()
                    } else t.toggleClass("collapsed"), t.set("aria-expanded", !t.hasClass("collapsed"));
        ...
        initializer: function(t) {
            var r, i;
            if (t.branchobj !== null) {
                for (r in t.branchobj) this.set(r, t.branchobj[r]);
                i = this.get("children"), this.set("haschildren", i.length > 0)
            }
            if (t.overrides !== null)
                for (r in t.overrides) this.set(r, t.overrides[r]);
        ...
        draw: function(t) {
            ...
            if (a && (!n || this.get("type") === o.ACTIVITY)) {
                ...
                if (a.classes)
                    for (var f in a.classes) u.addClass(a.classes[f])
            }
            if (!i) {
        ...
        ajaxLoad: function(t) {
            ...
            if (t.type === "actionkey" && t.action === "enter" && t.target.test("A")) return this.node.setAttribute("data-expandable", "0"), this.node.setAttribute("data-loaded", "1"), !0;
            if (this.node.hasClass("loadingbranch")) return !0;
            if (this.node.getAttribute("data-loaded") === "1") return !0;
        ...
        ajaxProcessResponse: function(t, n) {
            ...
            try {
                ...
                if (r.children && r.children.length > 0) {
                    var i = 0;
                    for (var s in r.children) typeof r.children[s] == "object" && (r.children[s].type === o.COURSE && i++, this.addChild(r.children[s]));
        ...
        addChild: function(e) {
            ...
            if (t.draw(this.getChildrenUL())) {
                ...
                var n = 0,
                    r, i = t.get("children");
                for (r in i) i[r].type === o.COURSE && n++, typeof i[r] == "object" && t.addChild(i[r]);
