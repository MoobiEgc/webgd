YUI.add('moodle-block_webgd-navigation', function (Y, NAME) {
 ...
 * @static
 */
M.block_webgd.expandablebranchcount = 1;
/**
...
TREE.prototype = {
    ...
    initializer : function(config) {
        ...
        if (M.block_webgd.expandablebranchcount > 0) {
...
BRANCH.prototype = {
    ...
    ajaxProcessResponse : function(tid, outcome) {
        ...
        try {
            ...
            Y.log('AJAX loading complete but there were no children.', 'note', 'moodle-block_webgd');
        } catch (ex) {
            // If we got here then there was an error parsing the result.
            Y.log('Error parsing AJAX response or adding branches to the navigation tree', 'error', 'moodle-block_webgd');
        }
